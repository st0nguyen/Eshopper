...
Route::any('/tim-kiem','HomeController@search');
...
Route::get('/deleted-product','ProductController@deleted_product');
Route::get('/destroy-product/{product_id}','ProductController@destroy_product');
...
Route::get('/processing-order/{order_id}','CheckoutController@processing_order');
Route::get('/processed-order/{order_id}','CheckoutController@processed_order');
